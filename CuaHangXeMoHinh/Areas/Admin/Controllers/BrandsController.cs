    ...
    public class BrandsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description")] Brand brand)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["SuccessMessage"] = $"Đã thêm thương hiệu {brand.Name} thành công!";
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] Brand brand)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    await _context.SaveChangesAsync();
                    TempData["SuccessMessage"] = $"Đã cập nhật thương hiệu {brand.Name} thành công!";
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
          ...
          .FirstOrDefaultAsync(b => b.Id == id);
            ...
            {
                TempData["ErrorMessage"] = $"Không thể xóa thương hiệu {brand.Name} vì còn {brand.Products.Count} sản phẩm thuộc thương hiệu này!";
                return RedirectToAction(nameof(Index));
            }
